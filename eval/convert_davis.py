...
# parser.add_argument('--i', '--in_folder', default='./results/davis2/', type=str)
# parser.add_argument('--d', '--dataset', default='/home/qinzheyun/Data/DAVIS/', type=str)

parser.add_argument('--out_folder', default='./results/davis_results/', type=str)
parser.add_argument('--in_folder', default='./results/davis2/', type=str)
parser.add_argument('--dataset', default='/home/qinzheyun/Data/DAVIS/', type=str)
